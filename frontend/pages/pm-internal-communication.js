...
export default function PMInternalCommunication() {
  ...
  const [conversations, setConversations] = useState([
    // ─── Employees ───────────────────────────────────────────
    {
      ...
      time: '9:50 AM',
      messages: [
        { id: 1, from: 'them', text: 'Hi PM, good morning! We have a new client project starting next week. Are you available to join the design team?', time: '9:00 AM' },
    ...
    // ─── Seniors ─────────────────────────────────────────────
    {
      ...
      time: '2:56 AM',
      messages: [
        { id: 1, from: 'them', text: 'Good morning, PM! Can you give me an update of the hiring progress for the office assigned position?', time: '2:36 AM' },
  ...
  return (
    <PMLayout>
      <PMPageLayout title="Internal Communication">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '22px' }}>
            <div
              style={{
                ...
                border: `1px solid ${colors.border}`, // Black border
                borderRadius: '30px',
                padding: '5px',
                gap: '4px',
              }}
            ...
            >
              ...
              <div
                style={{
                  ...
                  gap: '10px',
                  padding: '14px 16px',
                  borderTop: `1px solid ${colors.border}`, // Black border
                }}
              >
                <input
                  type="text"
